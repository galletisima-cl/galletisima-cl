  ...
  return <main className="contact-page">
    ...
    <section className="contact-grid shell">
      <article className="contact-card">
        ...
        <a className="contact-action whatsapp-action" href={`https://wa.me/${whatsappNumber}?text=${encodeURIComponent("Hola! Me gusta el catálogo, pero tengo una duda…")}`} target="_blank" rel="noreferrer">{readableNumber} <span>→</span></a>
      </article>
